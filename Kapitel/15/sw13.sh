...
ip link add vxlan0 type vxlan id 36 dstport 4789 local 13.13.13.13 group 239.1.1.36 ttl 5 dev e101-001-0 dev e101-002-0

# assign access interface to VLAN 36
opx-config-vlan create --id 36
opx-config-vlan set --id 36 --ports e101-005-0
brctl stp br36 on
